...
def process_files(args, conn, existing_tables):
    ...
    with Progress(
        ...
        for info in file_info_list:
            ...
            if table_name in existing_tables:
                ...
                logger.info(f"Found {Fore.GREEN}{num_new} new geometries{Style.RESET_ALL}, "
                       f"{Fore.YELLOW}{num_updated} updated geometries{Style.RESET_ALL}, "
                       f"and {Fore.BLUE}{num_identical} identical geometries{Style.RESET_ALL}. "
    ...
    logger.info(f"Summary of tasks: {Fore.GREEN}{total_new:,} new geometries added{Style.RESET_ALL}, "
               f"{Fore.YELLOW}{total_updated:,} geometries updated{Style.RESET_ALL}, "
               f"{Fore.BLUE}{total_identical:,} duplicate geometries skipped{Style.RESET_ALL}")
